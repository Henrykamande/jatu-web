<template>
  ...
  <div class="md:hidden sm:block block">
    ...
    <div class="container mt-1 mx-auto relative" style="margin-top: -5px">
    <div class="overflow-hidden sliderImg">
      <transition name="slide-fade" tag="div">
        <div v-for="i in [currentIndex]" :key="i">
          <img
            ...
            alt
            class="object-fill w-full sliderImg"
          />
        </div>
      </transition>
      ...
      <svg
        @click="prev"
        class="h-12 w-12 ml-4 prev absolute text-orange-400 hover:text-purple-400"
      ...
      <svg
        @click="next"
        class="h-12 w-12 mr-4 next absolute text-orange-400 hover:text-purple-400"
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
