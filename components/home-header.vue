<template>
  <div>
      ...
      <div style="color: #fff; font-family: Caveat">
        <div class="flex">
          <a href="#" target="_blank">
            <svg
              class="bi bi-facebook h-6 w-6 md:h-6 md:w-6 mr-2 cursor-pointer text-gray-300 hover:text-white"
          ...
          <a href="#" target="_blank">
            <svg
              class="bi bi-instagram h-6 w-6 md:h-6 md:w-6 cursor-pointer text-gray-300 hover:text-white"
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
              fill="currentColor"
    ...
    <!-- top header -->
    <div class="items-center justify-center grid md:grid-cols-7 p-4">
      <!-- logo div -->
