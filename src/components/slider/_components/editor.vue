<template>
  <v-container fluid>
    <v-row>
      ...
      <v-col cols="12">
        <v-text-field label="Heading 1" outlined dense v-model="record.h1"></v-text-field>
      </v-col>

      <v-col cols="12">
        <v-text-field label="Heading 2" outlined dense v-model="record.h2"></v-text-field>
      </v-col>

      <v-col cols="12">
        <v-text-field label="Button Url" outlined dense v-model="record.buttonUrl"></v-text-field>
      </v-col>
    </v-row>

    <v-row v-show="pageStatus == 'view'">
      <v-col cols="6">
        <v-img :src="`${serverUrl}/uploads/slider/${record.coverImage}`"></v-img>
      </v-col>
    </v-row>
    ...
    <v-row>
      ...
      <v-col cols="12">
        ...
        <v-btn color="accent" @click="sendData" :loading="loader" v-show="action == 'view'">
