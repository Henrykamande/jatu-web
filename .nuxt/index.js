...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Jubilant Afro farms","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fpng","href":"\u002Fjubilantafrofarms-ico.png"}],"style":[],"script":[]},
