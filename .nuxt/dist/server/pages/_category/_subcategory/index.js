...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_category/_subcategory/index.vue?vue&type=template&id=3040b9ab&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "relative container mx-auto px-2"
  }, [_vm._ssrNode((_vm.category ? "<div class=\"md:p-4 p-2 text-2xl font-bold border-b border-gray-300 flex justify-center\" data-v-3040b9ab><div data-v-3040b9ab>" + _vm._ssrEscape(_vm._s(_vm.meta.h1)) + "</div></div>" : "<!---->") + " "), _vm._ssrNode("<div class=\"md:px-6 min-h-screen\" data-v-3040b9ab>", "</div>", [_vm._ssrNode("<div class=\"grid md:grid-cols-12\" data-v-3040b9ab>", "</div>", [_vm._ssrNode("<div class=\"col-span-12\" data-v-3040b9ab>", "</div>", [_vm._ssrNode("<div class=\"grid md:grid-cols-4 grid-cols-2 gap-2 py-4\" data-v-3040b9ab>", "</div>", _vm._l(_vm.records, function (product) {
    return _vm._ssrNode("<div class=\"card p-2\" data-v-3040b9ab>", "</div>", [_c('product', {
      attrs: {
        "product": product
      }
    })], 1);
  }), 0), _vm._ssrNode(" <div class=\"bg-white p-3 mb-3\" data-v-3040b9ab><section data-v-3040b9ab>" + _vm._s(_vm.meta.footerContent) + "</section></div>")], 2)])])], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/_category/_subcategory/index.vue?vue&type=template&id=3040b9ab&scoped=true
...
/* harmony default export */ var _subcategoryvue_type_script_lang_js = ({
  ...
  async asyncData({
    ...
    try {
      ...
      const categoryData = await common["b" /* http */].get(subcategory);
      const {
        records,
        meta
      } = data;
