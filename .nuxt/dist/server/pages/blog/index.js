...
module.exports.__inject__ = function (context) {
  add("6181da74", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_eb3b26ea_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(125);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_eb3b26ea_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_eb3b26ea_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_eb3b26ea_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_eb3b26ea_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".header-img[data-v-eb3b26ea]{background-position:50%;background-repeat:no-repeat;background-size:cover}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/index.vue?vue&type=template&id=eb3b26ea&scoped=true
var render = function render() {
  ...
  }, null) + " data-v-eb3b26ea><div class=\"text-white\" data-v-eb3b26ea>\n        Enjoy daily news and articles relating to agricultural investments in Africa.<br data-v-eb3b26ea><br data-v-eb3b26ea>\n        Information is Power!\n      </div></div> "), _vm._ssrNode("<div class=\"relative container mx-auto px-2\" data-v-eb3b26ea>", "</div>", [_vm._ssrNode("<div class=\"md:p-4 p-2 text-2xl font-bold border-b border-gray-300 flex justify-center\" data-v-eb3b26ea><div data-v-eb3b26ea>Blog</div></div> "), _vm._ssrNode("<div class=\"md:px-6 min-h-screen\" data-v-eb3b26ea>", "</div>", [_vm._ssrNode("<div class=\"grid md:grid-cols-12\" data-v-eb3b26ea>", "</div>", [_vm._ssrNode("<div class=\"col-span-12\" data-v-eb3b26ea>", "</div>", [_vm._ssrNode("<div class=\"md:grid md:grid-cols-3 gap-2 py-4\" data-v-eb3b26ea>", "</div>", _vm._l(_vm.records, function (article) {
    return _vm._ssrNode("<div class=\"card p-2\" data-v-eb3b26ea>", "</div>", [_vm._ssrNode("<div data-v-eb3b26ea>", "</div>", [_c('nuxt-link', {
      attrs: {
        "to": `/blog/${article.url}`
      }
    }, [article.videoStatus != true ? _c('img', {
      staticClass: "w-96",
      staticStyle: {
        "width": "400px"
      },
      attrs: {
        "src": `${_vm.imageUrl}/uploads/blog/${article.coverImage}`,
        "alt": ""
      }
    }) : _vm._e(), _vm._v(" "), article.videoStatus == true ? _c('iframe', {
      attrs: {
        "width": "400",
        "height": "386",
      ...
      staticClass: "font-bold text-xl text-orange-600"
    }, [_vm._v(_vm._s(article.title))])])]), _vm._ssrNode(" "), _vm._ssrNode("<div data-v-eb3b26ea>", "</div>", [_vm._ssrNode(_vm._ssrEscape("\n                " + _vm._s(article.introText)) + "<br data-v-eb3b26ea> "), _c('nuxt-link', {
      staticClass: "text-green-600 text-lg underline",
      attrs: {
        "to": `/blog/${article.url}`
      }
    }, [_vm._v("Read More")])], 2)], 2), _vm._ssrNode(" <div class=\"py-4\" data-v-eb3b26ea>" + _vm._ssrList(article.attachments, function (doc, index) {
      return "<div class=\"inline-block flex py-1\" data-v-eb3b26ea><a" + _vm._ssrAttr("href", `${_vm.imageUrl}/uploads/attachments/${doc.fileName}`) + " class=\"text-blue-600 inline-block flex\" data-v-eb3b26ea><img" + _vm._ssrAttr("src", __webpack_require__(99)) + " alt class=\"h-6 w-6 mr-2\" data-v-eb3b26ea>" + _vm._ssrEscape("\n                  " + _vm._s(doc.title)) + "</a></div>";
    }) + "</div>")], 2);
  }), 0), _vm._ssrNode(" <div class=\"bg-white p-3 mb-3\" data-v-eb3b26ea></div>")], 2)])])], 2)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/blog/index.vue?vue&type=template&id=eb3b26ea&scoped=true
