...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/product/_url.vue?vue&type=template&id=6e85f774&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "container mx-auto md:px-36 px-2"
  }, [_vm._ssrNode("<div class=\"bg-white mt-3 p-3 font-bold text-2xl text-orange-500\" data-v-6e85f774><h1 data-v-6e85f774>" + _vm._ssrEscape(_vm._s(_vm.record.name)) + "</h1></div> "), _vm._ssrNode("<div class=\"grid md:grid-cols-3 grid-cols-1 gap-2 my-2 p-3 bg-white\" data-v-6e85f774>", "</div>", [_vm._ssrNode("<div data-v-6e85f774><img" + _vm._ssrAttr("src", `${_vm.imageUrl}/uploads/products/${_vm.record.cover_image}`) + " alt class=\"w-full h-80 object-fill\" data-v-6e85f774></div> "), _vm._ssrNode("<div data-v-6e85f774>", "</div>", [_vm._ssrNode("<div data-v-6e85f774>In Stock</div> <div class=\"mt-3\" data-v-6e85f774><input min=\"1\" placeholder=\"Qty\" type=\"number\"" + _vm._ssrAttr("value", _vm.qty) + " class=\"md:w-3/4 w-full border-2 border-gray-500 py-1 px-3 m-r-5 md:justify-around rounded outline-none focus:border-gray-400\" data-v-6e85f774></div> <div data-v-6e85f774><div class=\"font-bold text-red\" data-v-6e85f774>" + _vm._ssrEscape("\n          Ksh. " + _vm._s(_vm.record.currentPrice.toLocaleString()) + "\n        ") + "</div></div> "), _vm.record.outOfStock == false ? _vm._ssrNode("<div class=\"flex justify-between\" data-v-6e85f774>", "</div>", [_vm._ssrNode("<button type=\"button\" class=\"mt-2 py-1 px-3 mr-3 bg-orange-600 hover:bg-orange-500 rounded font-bold text-white focus:outline-none\" data-v-6e85f774>\n          Add To Cart\n        </button> "), !_vm.inFavorite(_vm.record) ? _c('font-awesome-icon', {
    staticClass: "h-6 w-6 mt-3 cursor-pointer",
    staticStyle: {
      "color": "#e11d48"
    },
    attrs: {
    ...
    on: {
      "click": function ($event) {
        return _vm.changeFavStatus(_vm.record);
      }
    }
  ...
  })], 2) : _vm._e(), _vm._ssrNode(" " + (_vm.record.outOfStock == true ? "<div class=\"text-red-800 font-bold py-2 flex justify-center\" data-v-6e85f774>\n        Sold Out\n      </div>" : "<!---->") + " <div class=\"mt-3\" data-v-6e85f774>Call Us On: +254 752 940 909</div>")], 2), _vm._ssrNode(" <div data-v-6e85f774><div class=\"bg-gray-200 p-2 mb-2\" data-v-6e85f774>More Details:</div></div>")], 2), _vm._ssrNode(" <div class=\"bg-white p-3\" data-v-6e85f774><div class=\"mb-2 font-bold border-b-2 border-gray-100\" data-v-6e85f774>\n      Product Description\n    </div> <div data-v-6e85f774>" + _vm._s(_vm.record.content) + "</div></div> "), _vm._ssrNode("<div class=\"bg-white p-3 mt-3 mb-3 grid md:grid-cols-12\" data-v-6e85f774>", "</div>", [_vm._ssrNode("<div class=\"col-span-12 font-bold\" data-v-6e85f774><span data-v-6e85f774>Related Products</span></div> "), _vm._ssrNode("<div class=\"col-span-12\" data-v-6e85f774>", "</div>", [_vm._ssrNode("<div class=\"grid md:grid-cols-4 grid-cols-2 gap-2 py-4\" data-v-6e85f774>", "</div>", _vm._l(_vm.relatedProducts, function (product) {
    return _vm._ssrNode("<div class=\"card p-2\" data-v-6e85f774>", "</div>", [_c('product', {
      attrs: {
        "product": product
      }
    })], 1);
...
// CONCATENATED MODULE: ./pages/product/_url.vue?vue&type=template&id=6e85f774&scoped=true
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/product/_url.vue?vue&type=script&lang=js
