<template>
  <div class="container mx-auto md:px-80 px-2 lg:min-h-screen">
    <div class="bg-white mt-6 p-3">
      <div>
        <div class="bg-orange-600 text-white font-bold px-6 py-2">Join Upcoming Event</div>
        <div>
            ...
            <table class="w-full text-sm md:text-base text-left border-2 border-white">
              ...
              <tbody>
                <tr class="border-b dark:bg-gray-800 dark:border-gray-900">
                  ...
                  <td class="border-2 border-white">{{ record.meetingAgenda }}</td>
                </tr>
                <tr class="border-b dark:bg-gray-800 dark:border-gray-900">
                  <td class="border-2 border-white">Date</td>
                  <td class="border-2 border-white">{{ record.meetingDate }}</td>
                </tr>
                <tr class="border-b dark:bg-gray-800 dark:border-gray-900">
                  <td class="border-2 border-white">Time</td>
                  <td class="border-2 border-white">{{ record.meetingTime }}</td>
                </tr>
                <tr class="border-b dark:bg-gray-800 dark:border-gray-900">
                  <td class="border-2 border-white">Time Zone</td>
                  <td class="border-2 border-white">{{ record.timeZone }}</td>
                </tr>
                <tr class="border-b dark:bg-gray-800 dark:border-gray-900">
                  <td class="border-2 border-white">Channel</td>
                  <td class="border-2 border-white">{{ record.meetingChannel }}</td>
                </tr>
                <tr class="border-b dark:bg-gray-800 dark:border-gray-900">
                  <td class="border-2 border-white">Venue</td>
                  <td class="border-2 border-white">{{ record.meetingVenue }}</td>
                </tr>
                <tr class="border-b dark:bg-gray-800 dark:border-gray-900">
                  <td class="border-2 border-white">More Details</td>
                  <td class="border-2 border-white">{{ record.details }}</td>
                </tr>
              </tbody>
            </table>
          </div>
